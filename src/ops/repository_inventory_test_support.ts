...
export type OpsRepositoryForTest = Awaited<
  ReturnType<typeof createOpsRepositoryForTest>
>;
...
export function buildInventoryQueryRow(
  ...
  return {
    ...
    bindingAuthorizationEndpoint: overrides.bindingAuthorizationEndpoint ??
      null,
...
export function readInventoryInstallEvidence(
  row: unknown,
...
export function readDetailInstallEvidence(
  detail: unknown,
): DeploymentActivitySnapshot | null {
  return (
    (detail as
