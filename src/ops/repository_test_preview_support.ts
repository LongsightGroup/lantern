...
export async function insertPreviewEvidence(
  ...
  await client.queryArray({
    text: 'INSERT INTO preview_evidence (preview_session_id, sequence, event_type, capability, summary, detail, occurred_at) VALUES ($1, $2, $3, $4, $5, $6::jsonb, $7)',
    args: [
