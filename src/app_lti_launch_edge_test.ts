  ...
  await withRuntimeOriginEnv(async () => {
      ...
      packageVersions: [
        buildPackageVersionRecord({
          ...
          artifact: {
            ...
            manifestPath:
              "var/packages/chapter-4-asteroids/0.1.0/manifest.json",
            entrypointPath:
        ...
        buildPackageVersionRecord({
          ...
          artifact: {
            ...
            manifestPath:
              "var/packages/chapter-4-asteroids/0.2.0/manifest.json",
            entrypointPath:
    ...
    await withFetchStub(
      ...
      async () => {
        ...
        }).request("https://lantern.example/lti/launch", {
          method: "POST",
          body: formData,
        });
