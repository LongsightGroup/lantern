...
function renderDeploymentVerificationRow(deployment: ControlPlaneDeploymentInventoryRow): string {
  ...
  return `<article class="table-row">
      ...
      <div class="table-row-meta">
        <span><strong>Setup:</strong> ${escapeHtml(describeDeploymentContext(deployment))}</span>
        <span><strong>Profile:</strong> ${escapeHtml(
          supportedPath === null
      ...
      ${
        internal?.evidenceUrl
          ? `<div class="button-row">
              <a class="button-ghost" href="${escapeHtml(internal.evidenceUrl)}">Open log</a>
            </div>`
          : ''
      }
    </article>`;
  ...
  return `<section class="stack">
      ...
      ${
        official.directoryUrl
          ? `<div class="button-row">
              <a class="button-ghost" href="${escapeHtml(official.directoryUrl)}">Open listing</a>
            </div>`
          : ''
      }
    </section>`;
