...
Deno.test('preview capability log shows durable launch, content-read, attempt, and finalize evidence after reload', async () => {
  ...
  await app.request(`http://localhost/runtime/sessions/${runtimeSessionId}/content`, {
    headers: { Authorization: `Bearer ${runtimeToken}` },
  });
  await app.request(`http://localhost/runtime/sessions/${runtimeSessionId}/attempt-events`, {
    method: 'POST',
    headers: {
