...
export interface TestAgsLaunchServiceOverrides extends Partial<LaunchAssignmentAndGradeServices> {
  lms?: LmsType;
}

export interface TestNrpsLaunchServiceOverrides extends Partial<LaunchNamesAndRolesService> {
  lms?: LmsType;
}
