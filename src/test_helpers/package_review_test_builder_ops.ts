...
export function buildLatestOfficialCertificationEvidence(
  ...
  return {
    ...
    checkedAt: overrides.checkedAt ?? DEFAULT_PHASE4_AT,
    summary: overrides.summary ?? '1EdTech lists Lantern as LTI Advantage Certified.',
    directoryUrl: overrides.directoryUrl ?? 'https://example.test/verification/1edtech-directory',
  };
}
