...
Deno.test("GET /admin/verification shows workflow-specific evidence, checked dates, and guidance links without blending workflows together", async () => {
    ...
    certificationWorkflowStatuses: [
      buildCertificationWorkflowStatus({
        ...
        latestInternal: {
          ...
          summary:
            "Core launch completed through the official certification harness.",
      ...
      buildCertificationWorkflowStatus({
        ...
        latestInternal: {
          ...
          summary:
            "Deep Linking return payload still needs another review pass.",
  ...
  assertStringIncludes(
    body,
    "Roster verification is still waiting on operator review.",
  );
  ...
  assertStringIncludes(
    body,
    "Run the LTI Core workflow in the official 1EdTech suite.",
  );
  assertStringIncludes(
    body,
    "Run the Deep Linking workflow in the official 1EdTech suite.",
  );
  assertStringIncludes(
    body,
  ...
  assertStringIncludes(
    body,
    "No internal evidence has been recorded for AGS yet.",
  );
  assertEquals(
    body.includes(
