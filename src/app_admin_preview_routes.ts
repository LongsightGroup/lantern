...
import {
  renderPreviewPage,
  type TestLaunchFormValues,
} from "./admin/preview_page.ts";
      ...
      try {
        ...
        return context.html(
          renderPreviewPage({
            ...
            formValues: buildTestLaunchFormValuesFromSession(
              session ?? savedDefaults,
            ),
...
function buildTestLaunchFormValuesFromFormData(
  formData: FormData,
): TestLaunchFormValues {
  return {
...
function buildTestLaunchOverrides(
  formValues: TestLaunchFormValues,
): PreviewLaunchOverrides {
  return {
    userRole: parseTestLaunchUserRole(formValues.userRole),
    courseId: formValues.courseId,
    assignmentId: formValues.assignmentId === ""
      ? null
