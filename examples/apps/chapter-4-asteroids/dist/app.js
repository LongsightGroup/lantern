(async function () {
  const fallbackContent = {
    ...
    instructions: 'Shoot the correct vocabulary target. Wrong targets cost points.',
    questions: [
      {
        id: 'q1',
  ...
  question.choices.forEach(function (choice) {
    ...
    button.addEventListener('click', async function () {
      ...
      status.textContent = correct ? 'Correct answer recorded' : 'Incorrect answer recorded';
  ...
  document.querySelector('#complete').addEventListener('click', async function () {
